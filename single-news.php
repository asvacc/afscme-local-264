            ...
            <div class="flex items-center justify-start pt-8 mt-8 text-sm border-t-2 border-gray-200 gap-x-4">
                ...
                <ul class="flex items-center list-none gap-x-2">
                    <?php foreach($categories as $category): ?>
                        <li><a class="px-2 py-1 text-xs text-white no-underline uppercase rounded-md bg-green" href="<?= get_term_link($category->term_id)?>"><?= $category->name ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
            <?php endif; ?>
...
<main id="primary" class="prose site-main">
